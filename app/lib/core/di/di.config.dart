...
import 'package:zlp_jokes/core/secure_storage/secure_storage.dart' as _i14;
...
import 'package:zlp_jokes/domain/rating/repository/rating_repository.dart'
    as _i10;
import 'package:zlp_jokes/domain/user/repostitory/user_repository.dart' as _i13;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i11.JokesRepository>(
        () => _i11.JokesRepository(gh<_i7.NetworkService>()));
    gh.factory<_i12.AnnotationsRepository>(
        () => _i12.AnnotationsRepository(gh<_i7.NetworkService>()));
    gh.factory<_i13.UserRepository>(
        () => _i13.UserRepository(gh<_i7.NetworkService>()));
    return this;
  }
}

class _$SecureStorage extends _i14.SecureStorage {}
